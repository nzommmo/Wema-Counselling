        ...
        <nav className="container mx-auto bg-white border-gray-200 relative">
            <div className="flex flex-wrap items-center justify-between py-4">
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer">
                    <img className="h-10 md:h-16 px-5 md:p-0" alt="Logo" src={Logo}/>
                </Link>
                ...
                <div className="flex gap-2 lg:hidden">
                    ...
                    >
                        <g fill="none" stroke="black" strokeLinecap="round" strokeWidth="2">
                            <path
                                d="M19.727 20.447c-.455-1.276-1.46-2.403-2.857-3.207C15.473 16.436 13.761 16 12 16c-1.761 0-3.473.436-4.87 1.24c-1.397.804-2.402 1.931-2.857 3.207"/>
